        ...
        <>
            ...
            <Modal isOpen={isResetModalOpen} onClose={() => setIsResetModalOpen(false)} title="Confirm Data Reset">
                <div className="space-y-4">
                    <p className="text-red-700 font-semibold">This is a highly destructive action and cannot be undone.</p>
                    <p className="text-gray-600">You are about to delete all bills and transaction history. This will permanently reset all revenue and sales data to zero.</p>
                    <p className="text-gray-600">To confirm, please type <strong className="font-mono text-red-800 bg-red-100 px-1 rounded">RESET</strong> into the box below.</p>
                    
                    <input
                        type="text"
                        value={resetConfirmationText}
                        onChange={(e) => setResetConfirmationText(e.target.value)}
                        className="w-full p-2 border border-gray-300 rounded-md text-center font-mono tracking-widest"
                        placeholder="RESET"
                    />
                    ...
                    <div className="flex justify-end gap-3 mt-4">
                        ...
                        <button
                            ...
                            className="px-6 py-2 bg-red-600 text-white rounded-md font-semibold hover:bg-red-700 disabled:bg-red-300 disabled:cursor-not-allowed"
                        >
                            Confirm Reset
                        </button>
                    </div>
